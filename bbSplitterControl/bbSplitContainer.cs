...
namespace bb.Components
{
	...
	[ToolboxBitmap(typeof(bbSplitContainer), "Resources.collapse.bmp")]
	public class bbSplitContainer : SplitContainer, ISupportInitialize
	{
		#region Variables
		...
		private Cursor pointer = new Cursor(typeof(bbSplitContainer), "Resources.pointer.cur");
		private Cursor pointer_no = new Cursor(typeof(bbSplitContainer), "Resources.pointer_no.cur");
		#endregion

		public bbSplitContainer()
		{
		...
		#region Properties
		[Category("Collapsible"), Description("Splitter de kullanılan buton bitmap")]
		[DefaultValue(null)]
		...
		[Category("Collapsible"), Description("Splitter Butonlarının Konumu")]
		...
		[Category("Collapsible"), Description("Buton oluşturma tekniği")]
		...
		[Category("Collapsible"), Description("Panel nasıl etkilensin")]
		...
		[Category("Collapsible"), Description("Splitter panel ayırıcı gösterimi")]
		[DefaultValue(false)]
		...
		public void LoadImage()
		{
			...
			ofd.Filter = "Resimler (*.bmp;*.png;*.gif;*.ico)|*.bmp;*.png;*.gif;*.ico|All files (*.*)|*.*";
			ofd.FilterIndex = 1;
